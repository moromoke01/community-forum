  ...
  return (
    <div className="community w-full bg-white p-10 shadow-md relative">
      <div className="community-body w-3/4 mx-auto flex flex-col items-left pb-5 overflow-hidden">
        <h3 className="mb-5"><b>Community</b></h3>
        {user && (
          <div>
            <form
                ...
                selectedPost.id === post.id && (
                  <div>
                    ...
                    />
                      ...
                      <i className="Send-Comment px-4  bg-blue-500 text-white rounded-md"><LuSendHorizonal className="text-white-500 text-2xl mt-2" onClick={handleCommentSubmit}/></i>
                    </div>
                  </div>
                )}
            </div>
